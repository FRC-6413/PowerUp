...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveBaseRMM = new WPI_TalonSRX(1);
        //LiveWindow.addActuator("DriveBase", "LFM", (TalonSRX) driveBaseLFM);

        driveBaseRFM = new WPI_TalonSRX(2);
        
        driveBaseRRM = new WPI_TalonSRX(0);
        ...
        driveBaseLMM = new WPI_TalonSRX(4);
        //LiveWindow.addActuator("DriveBase", "RRM", (TalonSRX) driveBaseRRM);
        
        driveBaseLRM = new WPI_TalonSRX(5);
